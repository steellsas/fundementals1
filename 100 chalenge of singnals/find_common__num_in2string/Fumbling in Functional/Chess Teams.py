...
# smarties and cleveries, will clash to determine whose chess skills are better. The
# teams have the same number of members, and the ith member of smarties will play against the ith member of
# cleveries in the ith game for each valid i
#
